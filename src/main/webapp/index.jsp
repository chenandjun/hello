                ...
                <ul class="layui-nav top_menu">j
                   <%-- <li class="layui-nav-item" pc>
                    ...
                    <li class="layui-nav-item" id="userInfo">
                        <!-- 头像 -->
                        <a href="javascript:;"><img src="static/image/face.jpg" class="layui-nav-img userAvatar" width="35" height="35"><cite class="adminName">驊驊龔頾</cite></a>
                        <dl class="layui-nav-child">
            ...
            <div class="navBar layui-side-scroll" id="navBar">
                <ul class="layui-nav layui-nav-tree">
                    <li class="layui-nav-item layui-this">
                        <a href="javascript:;" data-url="page/main.html"><i class="layui-icon" data-icon=""></i><cite>首页地图</cite></a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="layui-body layui-form">
            <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
                <ul class="layui-tab-title top_tab" id="top_tabs">
                    <li class="layui-this" lay-id=""><i class="layui-icon">&#xe68e;</i> <cite>首页地图</cite></li>
                </ul>
